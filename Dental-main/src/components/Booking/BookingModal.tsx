...
export const BookingModal = ({ 
  ...
  return (
        ...
        <DialogContent className="max-w-md rounded-3xl border border-slate-200 bg-white shadow-2xl overflow-hidden p-0">
          ...
          <div className="p-6 pt-2 max-h-[70vh] overflow-y-auto">
            ...
            <div className="space-y-6 py-4">
              ...
              <Button
                variant="outline"
                className="w-full flex items-center gap-3 p-4 bg-green-50 rounded-2xl border-2 border-green-200 hover:bg-green-100 transition-colors h-auto"
                onClick={handleCallNow}
              >
                <Phone className="w-5 h-5 text-green-600 shrink-0" />
                <div className="flex-1 text-left">
                  <p className="text-sm font-bold text-green-700">Call Doctor Now</p>
                  <p className="text-xs text-green-600">Skip the appointment and call the doctor immediately</p>
                </div>
    ...
    {/* Call Now Popup */}
    <Dialog open={showCallPopup} onOpenChange={(open) => !open && setShowCallPopup(false)}>
      <DialogContent className="max-w-sm rounded-3xl border border-slate-200 bg-white shadow-2xl overflow-hidden p-0">
        ...
        <div className="px-6 pb-6">
          <div className="bg-green-50 rounded-2xl p-4 border border-green-200 space-y-4">
            <div className="flex items-start gap-3">
              <div className="bg-white p-2 rounded-xl border border-green-100">
                <Stethoscope className="w-5 h-5 text-green-600" />
              </div>
              <div className="flex-1">
                <p className="text-xs text-green-600 font-medium uppercase tracking-wider">Doctor</p>
                <p className="font-bold text-slate-900">{doctor.name}</p>
                <p className="text-xs text-slate-500">{doctor.specialization}</p>
              </div>
            </div>
            ...
            <div className="pt-2 border-t border-green-200">
              <p className="text-xs text-green-600 font-medium uppercase tracking-wider mb-1">Hospital</p>
              <p className="font-bold text-slate-900">{doctor.clinicName}</p>
            </div>

            <div className="pt-2 border-t border-green-200">
              <p className="text-xs text-green-600 font-medium uppercase tracking-wider mb-1">Phone Number</p>
              <div className="flex items-center gap-2">
                <p className="font-bold text-slate-900 text-lg">{doctor.phone || '+1-800-DENTAL-1'}</p>
                <Button
                  size="sm"
                  className="bg-green-600 hover:bg-green-700 text-white rounded-xl px-3 py-1 text-xs"
                  onClick={() => {
                    const phoneNumber = doctor.phone || '+1-800-DENTAL-1';
          ...
          <p className="text-xs text-slate-500 mt-4 text-center">
            Please call this number to connect with the doctor immediately
          </p>
        </div>
