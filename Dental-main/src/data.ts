...
const generateMoreDoctors = (count: number): Doctor[] => {
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      clinicName: clinic,
      phone: `+91-${Math.floor(Math.random() * 900) + 100}-${Math.floor(Math.random() * 9000) + 1000}-${Math.floor(Math.random() * 9000) + 1000}`,
...
export const DUMMY_DOCTORS: Doctor[] = [
  {
    ...
    dentalCollege: 'Tamil Nadu Government Dental College, Chennai',
  ...
  },
  {
    ...
    dentalCollege: 'Christian Medical College, Vellore',
  ...
  },
  {
    ...
    dentalCollege: 'SRM Dental College, Chennai',
  ...
  },
  {
    ...
    dentalCollege: 'All India Institute of Medical Sciences, New Delhi',
  ...
  },
  {
    ...
    dentalCollege: 'Saveetha Dental College, Chennai',
